Option Explicit On
Option Strict On
Partial Class PopupsUserTaskList
...
#End Region
    ...
    Private Sub SetPageDefaults()
        ...
        If defaults IsNot Nothing Then
            ...
            If defaults.DoesDefaultValueExist(RIUserDefaults.UserProfileTypes.BusinessUnit) AndAlso defaults.DoesDefaultValueExist(RIUserDefaults.UserProfileTypes.Area) Then
                ...
                filters.BusinessUnitArea = defaults.GetDefaultValue(RIUserDefaults.UserProfileTypes.BusinessUnit) & " - " & defaults.GetDefaultValue(RIUserDefaults.UserProfileTypes.Area)
            End If
        End If
    End Sub
            ...
            If instanceOfTaskHeader IsNot Nothing AndAlso
                ...
                With _gvTaskHeaders
                    ...
                    If .Rows.Count > 0 Then
                        ...
                        Web.UI.ScriptManager.RegisterStartupScript(_udpTaskList, _udpTaskList.GetType(), "SortGrid_" & .ClientID, String.Format(System.Globalization.CultureInfo.CurrentCulture, "$(function(){{$('#{0}').tablesorter(); }});", .ClientID), True)
                    End If
                End With
            End If
    ...
    Private Sub Refresh_Click(sender As Object, e As EventArgs) Handles _btnRefresh.Click
        PopulateMyTaskHeaders()
    End Sub
End Class
