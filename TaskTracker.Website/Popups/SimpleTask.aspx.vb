...
#Region "Methods"
                ...
                If Not Page.IsPostBack Or useParentData Then 'populate the fields from database data
                    With currentTaskItem
                        If useParentData Then
                            ...
                            _EstimatedDueDate.StartDate = String.Empty
                        ...
                        Else
                            ...
                            _EstimatedDueDate.StartDate = CStr(.DaysBefore)
    ...
    Private Sub UpdateSubTask()
        ...
        With currentTaskItem
            ...
            If IsDate(.DueDate) AndAlso IsDate(Me._EstimatedDueDate.StartDate) Then
                If CDate(.DueDate) <> CDate(Me._EstimatedDueDate.StartDate) Then
                    .DueDate = Me._EstimatedDueDate.StartDate
                    isDirty = True
                    subTaskWasClosed = True
                End If
            ElseIf .DueDate <> Me._EstimatedDueDate.StartDate Then
                .DueDate = IP.MEASFramework.ExtensibleLocalizationAssembly.DateTime.GetLocalizedDateTime(Me._EstimatedDueDate.StartDate, "EN-US", "d")
                isDirty = True
                subTaskWasClosed = True
            End If
        ...
        If isDirty = True Then
            ...
            If TaskItemNumber = "-1" Then
                ...
                End Try
            Else
                'Me.DisplayMessage("The subtask has been successfully saved.")
            End If
        End If
        'PopulateComments()
