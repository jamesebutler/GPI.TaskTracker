    ...
    Public Sub HandlePageLoad()
        ...
        Try            
            ...
            If Request.QueryString("HeaderNumber") IsNot Nothing AndAlso IsNumeric(Request.QueryString("HeaderNumber")) Then
                ...
                _ifrTaskItems.Attributes.Item("src") = Page.ResolveUrl("~/Popups/TaskList.aspx?HeaderNumber=" & TaskHeaderNumber & "&ShowHeaderInfo=True")
                LoadIframe()
            ...
            If RefSite.ToLower = "moc" Or RefSite.ToLower = "ri" Or RefSite.ToLower = "outage" Or RefSite.ToLower = "iris" Or RefSite.ToLower = "tanks" Then
                ...
                Me._ifrTaskItems.Attributes.Item("src") = ""
                LoadIframe()
            ...
            Else
                ...
                'Display Task Items for the current Header
                _ifrTaskItems.Attributes.Item("src") = Page.ResolveUrl(IP.Bids.SiteURLs.GetTaskListURL(TaskHeaderNumber, RefSite, True, True, True))
                LoadIframe()
